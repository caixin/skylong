...
<div class="box box-<?= validation_errors() ? 'danger' : 'success' ?>">
    ...
    <div class="box-body">
        <form method="post" role="form" action="">
            ...
            <div class="form-group <?= form_error('keyword') ? 'has-error' : '' ?>">
                <label>关键字</label>
                <input type="text" name="keyword" class="form-control" placeholder="Enter ..." value="<?= isset($row['keyword']) ? $row['keyword'] : '' ?>">
                <?= form_error('keyword', '<span class="help-block">', '</span>') ?>
            </div>
