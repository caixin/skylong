...
<div class="box">
    <div class="box-header">
        <form method="post" action="">
            ...
            <div class="col-xs-1" style="width:auto;">
                <label>备注</label>
                <input type="text" name="note" class="form-control" placeholder="请输入..." value="<?= isset($where['note']) ? $where['note'] : '' ?>">
            </div>
            <div class="col-xs-1" style="width:auto;">
                <label>&nbsp;</label>
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><?= sort_title('ip', 'IP位置', $this->cur_url, $order, $where) ?></th>
                    <th><?= sort_title('note', '备注', $this->cur_url, $order, $where) ?></th>
                    <th width="100"><?= sort_title('create_time', '添加时间', $this->cur_url, $order, $where) ?></th>
