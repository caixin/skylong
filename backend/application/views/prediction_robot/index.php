        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><?= sort_title('axis_y', 'Y轴上限', $this->cur_url, $order, $where) ?></th>
                    <th><?= sort_title('total_formula', '投注总额计算公式', $this->cur_url, $order, $where) ?></th>
                    <th><?= sort_title('bet_formula', '下注公式', $this->cur_url, $order, $where) ?></th>
            ...
            <tbody>
                <?php foreach ($result as $row) : ?>
                    <tr>
                        ...
                        <td><?= $row['axis_y'] ?></td>
                        <td><?= $row['total_formula'] ?></td>
                        <td><?= $row['bet_formula'] ?></td>
