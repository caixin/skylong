...
<div class="box">
    ...
    <div class="nav-tabs-custom">
        <?php $this->load->view("{$this->router->class}/_tabs", array('type'=>2)); ?>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="col-xs-1" style="width:auto;">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <?php foreach (Ettm_lottery_cheat_model::$status2List as $key => $val) : ?>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><?= sort_title('numbers', '号码', $this->cur_url, $order, $where) ?></th>
                        ...
                        <tbody>
                            <?php foreach ($result as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= $row['qishu'] ?></td>
                                    <td><?= $row['numbers'] ?></td>
                                    <td><?= Ettm_lottery_cheat_model::$status2List[$row['status']] ?></td>
...
<script>
    ...
    function add() {
        layer.open({
            ...
            offset: ['20px', ''],
            area: ['50%', '90%'],
            content: '<?= site_url("{$this->router->class}/create/$where[operator_id]/2") ?>'
        });
    }
