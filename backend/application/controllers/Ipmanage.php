...
class Ipmanage extends MY_Controller
{
    ...
    public function index()
    {
        ...
        // get total.
        $total = $this->ipmanage_db->where($where)->count();
        ...
        // get main data.
        $result = $this->ipmanage_db->where($where)
            ->order($order)
    ...
    public function create()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $this->form_validation->set_rules($this->ipmanage_db->rules());

            if ($this->form_validation->run() == true) {
                $this->ipmanage_db->insert($row);
